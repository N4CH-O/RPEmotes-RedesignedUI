Config = {
    MenuColor = '#905FE3', -- Accent color for the menu UI (use Hex format like #A6136D or #3498db)
    ...
    EmoteCooldownMs = 3000, -- Emote Cooldown in milliseconds. Prevents switching emotes too quickly. If nil, no cooldown is enforced
    ...
    RecoverEmotesAfterRagdoll = false -- If true, the resource will attempt to recover emotes after being bumped / ragdolled. Doesn't work for all.
}
