...
-- Dummy NativeUI to prevent errors when InitMenu runs in background
NativeUI = {
    CreatePool = function() 
        return { 
            Add = function() end, 
            IsAnyMenuOpen = function() return false end, 
            CloseAllMenus = function() end, 
            RefreshIndex = function() end, 
            ProcessMenus = function() end,
            AddSubMenu = function() 
                return { 
                    AddItem=function()end, 
                    UpdateScaleform=function()end, 
                    CurrentSelection=function() return 1 end, 
                    OnIndexChange=function()end, 
                    OnItemSelect=function()end, 
                    OnListSelect=function()end, 
                    OnMenuChanged=function()end,
                    Clear=function()end,
                    RemoveItemAt=function()end,
                    Visible=function()end
                } 
            end
        } 
    end,
    CreateMenu = function() return { Visible = function() end, AddItem = function() end, UpdateScaleform = function() end, RemoveItemAt = function() end, CurrentSelection = function() return 1 end } end,
    CreateItem = function() return { Enabled = function() end } end,
    CreateListItem = function() return { Enabled = function() end } end,
}
